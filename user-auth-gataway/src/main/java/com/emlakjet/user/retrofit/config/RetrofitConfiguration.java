package com.emlakjet.user.retrofit.config;
...
public class RetrofitConfiguration {
    ...
    @Bean
    public IAdvertisementServiceRequest advertisementServiceRequest(Retrofit.Builder secureKeyBuilder,
                                                                    @Value("${advertisement.service.url}") String baseUrl) {
        return secureKeyBuilder
                .baseUrl(baseUrl)
                .build()
                .create(IAdvertisementServiceRequest.class);
    }
